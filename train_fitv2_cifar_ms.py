    ...
    for step in range(global_steps, accelerate_cfg.max_train_steps):
        ...
        with accelerator.accumulate(model):
            ...
            #for _ in range(4):
                ...
                mod_index = layer_idx % (3 // 3) / 3
                mod_index_next = (layer_idx + 1) % (3 // 3) / 3
                ...
                model_kwargs = dict(y=y, target_layer_start=0, target_layer_end=number_of_layers_for_perflow)
