...
def main(args):
    ...
    if rank == 0:
        ...
        sample_z = torch.randn(
            (sample_batch_size, model.in_channels, latent_size, latent_size)
        ...
        class SamplingWrapper(torch.nn.Module):
            ...
            def forward(self, x):
                ...
                for idx in range(self.num_steps):
                    ...
                    noise_pred = self.model(z, timestep, y=y)
                    # Simplified update rule for FLOPs calculation
                    z = z + (1/self.num_steps) * noise_pred  
                return z
    ...
    for _ in pbar:
        ...
        torchvision.utils.save_image(samples, f"/hub_data2/dogyun/dit-samples-{args.num_sampling_steps}.jpg", normalize=True, scale_each=True)
    ...
    if rank == 0:
        ...
        npz_path = f"/hub_data4/dogyun/DiT-samples-{args.num_sampling_steps}.npz"
